...
github.io를 이용해 정적 블로그를 무료로, 쉽게 구축할 수 있다는 소식을 접하여 commit + bloging을 하고자 인터넷을 뒤져 간단하게 구축하게 되었다.
그러던 중 다른 화려한 git 블로그를 접하게 되면서 theme적용을 결심하게 되었다.[Imreplay님의 JEKYLL + Github.io 블로그 구축 정리](https://imreplay.com/blogging/minimal-mistakes-%ED%85%8C%EB%A7%88%EB%A5%BC-%EC%9D%B4%EC%9A%A9%ED%95%B4-githubio-%EB%B8%94%EB%A1%9C%EA%B7%B8-%EA%B5%AC%EC%B6%95%ED%95%98%EA%B8%B0/)
jekyll theme를 적용한 뒤 기존에 있던 file들을 옮기는 과정에서
![image](https://user-images.githubusercontent.com/33077726/53994085-9139b200-4174-11e9-893b-67f862fe4fc8.png)
위와 같이 오류가 발생하면서 gitiopage가 이전 버전에서 바뀌지 않게 된 것이었다.

하지만 어째서인지 어떤 부분에서 오류가 뜨고 있는지 확인할 수 없었다.
...
[류승형님의 Jekyll install on window](https://shryu8902.github.io/_posts/2018-06-22-jekyll-on-windows/) 이 두 가지였다.

위의 문서를 참조하며 설치하였으나 쉽게 실행되지 않았고, github.io에서 theme를 사용해서 서버를 여는 것과 달리 직접 필요한 file들을 전부 download해야했다.

npm과 비슷한 역할을 하는 gem을 사용하기 위해 ruby를 설치하였고 블로그에 필요한 패키지는 Gemfile을 참조하여 download받았다.
...
평소 하나에 깊게 빠지지 못하고, 수박 겉핥기 식으로 공부하는 나에게 있어서 이번 error는 깊게 공부하는 것도 좋다는 것을 일깨워 준 것 같다.
